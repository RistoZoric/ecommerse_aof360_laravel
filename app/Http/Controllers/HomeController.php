...
class HomeController extends Controller
{
    ...
    public function profileUpdate(Request $request, $id)
    {
       ...
       // $request->photo->move(public_path('web'), $user->photo);
    
    //    $file = explode(',', $request->hasFile('photo'));  
       $file = $request->file('photo');
        
       $extension = $request->file('photo')->getClientOriginalName();
       
       $filename = 'company-logo-' . time() . '.' . $file->getClientOriginalExtension();
       $path = $file->move('/var/www/ecomelect.snckapp.com/public/user_profile', $filename);
    ...
    public function userOrderCancel($id)
    {
        ...
        if ($order) {
                ...
                $status = $order->update(array('status' => 'cancel'));
                if ($status) {
    ...
    public function orderView($id)
    {
        ...
        return view('web.pages.order_view')->with('order', $orderview);
    }
