<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <button id="sidebarToggleTop" class="btn btn-link-red  rounded-circle mr-3">
    ...
    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
      <div class="input-group">
        ...
        <div class="input-group-append">
          <button class="btn btn-link-red-bg" type="button">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <a class="btn btn-icon btn-circle btn-light dj" href="{{route('home')}}" target="_blank" title="Browse Website">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="mr-2 d-none d-lg-inline tgr text-right">{{Auth()->user()->name}}
