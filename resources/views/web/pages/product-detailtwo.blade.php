        ...
        <section class="shop-details-area pb-80">
            <div class="container">
               <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 order-md-1 order-3">
                        <div class="pro-content pro-content-two">
                            ...
                            <div class="pro-social mb-45">
                                <a href="#"><img src="{{URL::asset('web/img/payment/pro-details-social.jpg')}}" class="img-fluid" alt=""></a>
                            </div>
                            <div class="about-pro">
                                <ul class="mb-40">
                    ...
                    <div class="col-lg-5 col-md-6 order-md-2 order-1">
                        <div class="pro-img">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home5" role="tabpanel" aria-labelledby="home-tab5"><img src="{{URL::asset('web/img/allproducts/pro-details.jpg')}}" class="img-fluid" alt=""></div>

                                <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                                    <img src="{{URL::asset('web/img/allproducts/pro-details.jpg')}}" class="img-fluid" alt="">
                                </div>
                            ...
                            <ul class="nav" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab5" data-toggle="tab" href="#home5" role="tab" aria-controls="home5" aria-selected="true">
                                        <img src="{{URL::asset('web/img/allproducts/pro-details-small-1.jpg')}}" class="img-fluid" alt="">
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab5" data-toggle="tab" href="#profile5" role="tab" aria-controls="profile5" aria-selected="false">
                                        <img src="{{URL::asset('web/img/allproducts/pro-details-small-2.jpg')}}" class="img-fluid" alt="">
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab5" data-toggle="tab" href="#contact5" role="tab" aria-controls="contact5" aria-selected="false">
                                        <img src="{{URL::asset('web/img/allproducts/pro-details-small-3.jpg')}}" class="img-fluid" alt="">
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="desc-wrapper">
                            <ul class="nav custom-tabs" id="myTab1" role="tablist">
                                <li class="nav-item">
                            ...
                            <div class="product__active owl-carousel">
                                    ...
                                    <div class="product__box">
                                        ...
                                        <div class="product__thumb">
                                            <a href="product-details.html" class="img-wrapper">
                                                <img class="img" src="{{URL::asset('web/img/allproducts/products__thumb__33.jpg')}}" alt="">
                                                <img class="img secondary-img" src="{{URL::asset('web/img/allproducts/products__thumb__05.jpg')}}" alt="">
                                            </a>
                                        </div>
                                ...
                                <div class="product__single">
                                    <div class="product__box">
                                        ...
                                        <div class="product__thumb">
                                            <a href="product-details.html" class="img-wrapper">
                                                <img class="img" src="{{URL::asset('web/img/allproducts/products__thumb__34.jpg')}}" alt="">
                                                <img class="img secondary-img" src="{{URL::asset('web/img/allproducts/products__thumb__14.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product__content--rating d-flex justify-content-between">
                                            <div class="rating">
                                ...
                                <div class="product__single">
                                    <div class="product__box">
                                        ...
                                        <div class="product__thumb">
                                            <a href="product-details.html" class="img-wrapper">
                                                <img class="img" src="{{URL::asset('web/img/allproducts/products__thumb__35.jpg')}}" alt="">
                                                <img class="img secondary-img" src="{{URL::asset('web/img/allproducts/products__thumb__33.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product__content--rating d-flex justify-content-between">
                                            <div class="rating">
                                ...
                                <div class="product__single">
                                    <div class="product__box">
                                        ...
                                        <div class="product__thumb">
                                            <a href="product-details.html" class="img-wrapper">
                                                <img class="img" src="{{URL::asset('web/img/allproducts/products__thumb__36.jpg')}}" alt="">
                                                <img class="img secondary-img" src="{{URL::asset('web/img/allproducts/products__thumb__34.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product__content--rating d-flex justify-content-between">
                                            <div class="rating">
                                ...
                                <div class="product__single">
                                    <div class="product__box">
                                        ...
                                        <div class="product__thumb">
                                            <a href="product-details.html" class="img-wrapper">
                                                <img class="img" src="{{URL::asset('web/img/allproducts/products__thumb__37.jpg')}}" alt="">
                                                <img class="img secondary-img" src="{{URL::asset('web/img/allproducts/products__thumb__35.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product__content--rating d-flex justify-content-between">
                                            <div class="rating">
                                ...
                                <div class="product__single">
                                    <div class="product__box">
                                        ...
                                        <div class="product__thumb">
                                            <a href="product-details.html" class="img-wrapper">
                                                <img class="img" src="{{URL::asset('web/img/allproducts/products__thumb__38.jpg')}}" alt="">
                                                <img class="img secondary-img" src="{{URL::asset('web/img/allproducts/products__thumb__33.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product__content--rating d-flex justify-content-between">
