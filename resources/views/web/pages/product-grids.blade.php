                        ...
                        {{-- {{$products}} --}}
                            ...
                            <div class="product__single col-lg-3">
                                <div class="product__box">
                                    ...
                                    <div class="product__content--rating d-flex justify-content-between row">
                                        ...
                                        @php
                                                ...
                                                <del class="grenadier-color f-600">${{number_format($product->price,2)}}</del>
                                                <span class="grenadier-color f-600">${{number_format($after_discount,2)}}</span>
