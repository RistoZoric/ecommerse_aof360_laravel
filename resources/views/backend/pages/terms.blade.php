...
<div class="card">
    <h5 class="card-header">Term&Conditions Page</h5>
    <div class="card-body">
    <form method="post" action="{{route('pages-terms')}}">
        @csrf 
        <div class="form-group">
          <label for="termsPage" class="col-form-label">Page Contents <span class="text-danger">*</span></label>
          <textarea class="form-control" id="termsPage" name="terms_page"></textarea>
          @error('terms_page')
...
<script>
    $(document).ready(function() {
      $('#termsPage').summernote({
        placeholder: "Write Terms and Conditions Contents.....",
          tabsize: 2,
          height: 550
      });
