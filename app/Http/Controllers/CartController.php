...
class CartController extends Controller
{
    ...
    public function __construct(Product $product, Shipping $shipping){
    ...
    public function addToCart(Request $request){
        ...
        if($already_cart) {
            ...
            $cart->save();
            $wishlist=Wishlist::where('user_id',auth()->user()->id)->where('product_id',$product->id)->update(['cart_id'=>$cart->id]);
        }
