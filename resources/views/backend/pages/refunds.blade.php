...
<div class="card">
    <h5 class="card-header">Refunds Policy Page</h5>
    <div class="card-body">
    <form method="post" action="{{route('ecommerce-general')}}">
        @csrf 
        <div class="form-group">
          <label for="refundsPage" class="col-form-label">Page Contents <span class="text-danger">*</span></label>
          <textarea class="form-control" id="refundsPage" name="refunds_page"></textarea>
          @error('refunds_page')
...
<script>
    $(document).ready(function() {
      $('#refundsPage').summernote({
        placeholder: "Write Refund Policy Contents.....",
          tabsize: 2,
          height: 550
      });
