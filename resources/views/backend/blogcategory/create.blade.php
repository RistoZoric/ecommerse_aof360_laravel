...
<div class="card">
    <h5 class="card-header">Add Blog Category Page</h5>
    <div class="card-body">
      <form method="get" action="{{route('blog-category-store')}}">
        {{csrf_field()}}
        ...
        <input id="inputTitle" type="text" name="description" placeholder="Enter Descriptions"  value="{{old('description')}}" class="form-control">
        @error('title')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
