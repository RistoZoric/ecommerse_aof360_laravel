...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="site_title" name="site_title">{{$data->site_title}}</textarea>
          @error('site_title')
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="quote" name="meta_keywords">{{$data->meta_keywords}}</textarea>
          @error('meta_keywords')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <textarea class="form-control" id="description" name="meta_description">{{$data->meta_description}}</textarea>
        ...
        <div class="form-group">
          <label for="copyright" class="col-form-label">Copyright Text <span class="text-danger">*</span></label>
        <div class="form-group">
