            ...
            @foreach($reviews as $review)  
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        <a href="{{route('user.productreview.edit',$review->id)}}" class="btn-s float-left mr-1" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        <form method="POST" action="{{route('user.productreview.delete',[$review->id])}}">
                          @csrf 
                          @method('delete')
                              <button class="m_btn-s" data-id={{$review->id}} data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
                        </form>
                    </td>
                </tr>  
            @endforeach
