...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Shipping Rule</h6>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-bordered" id="banner-dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th>S.N.</th>
              <th>Based on product's price</th>
              <th>Based on product's weight (G)</th>
              <th>Price</th>
              <th>Status</th>
              <th>Action</th>
            </tr>
          ...
          <tbody>
            @foreach($shippings as $shipping)   
                <tr>
                    <td>{{$shipping->id}}</td>
                    <td>${{$shipping->from_p}} — ${{$shipping->to_p}}</td>
                    <td>{{$shipping->from_w}}g — {{$shipping->to_w}}g</td>
